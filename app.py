...
# ==========================================================================
# ✓ creación automática de bloc de notas con registros nuevos
# ==========================================================================
...
def crear_bloc_notas(tipo, datos):
    ...
    with open(archivo, 'w', encoding='utf-8') as bloc:
        ...
        bloc.write('\nEste archivo se creó automáticamente al guardar el registro en SQL Server.\n')
...
# ==========================================================================
# ✓ datos ficticios peruanos para demo del dashboard
# ===========================================================================

def titulo(texto):
    return ' '.join(palabra.capitalize() for palabra in str(texto).split())

CLIENTES_DEMO = [('Ana','Quispe','Av. Arequipa 1250, Lima'),('Luis','Flores','Jr. Cusco 455, Lima'),('Maria','Huaman','Av. Grau 230, Barranco'),('Carlos','Ramos','Calle Los Pinos 88, Surco'),('Rosa','Mamani','Av. La Marina 710, San Miguel'),('Jorge','Torres','Jr. Amazonas 321, Cercado'),('Lucia','Vargas','Av. Benavides 1420, Miraflores'),('Diego','Castro','Calle Lima 987, Ate'),('Valeria','Paredes','Av. Universitaria 650, Los Olivos'),('Miguel','Salazar','Jr. Junin 541, Callao')]
PRODUCTOS_DEMO = [
('Arroz Extra','Costeño',4.80,'Abarrotes','arroz.svg'),('Aceite Vegetal','Primor',9.90,'Abarrotes','aceite.svg'),('Fideos Tallarin','Don Vittorio',4.20,'Abarrotes','fideos.svg'),('Azucar Rubia','Cartavio',4.50,'Abarrotes','azucar.svg'),('Atun En Trozos','Florida',6.70,'Abarrotes','atun.svg'),('Quinua Seleccionada','Valle Andino',8.90,'Abarrotes','quinua.svg'),('Lenteja Bebé','Costeño',6.10,'Abarrotes','lenteja.svg'),('Harina Preparada','Blanca Flor',5.70,'Abarrotes','harina.svg'),
('Leche Evaporada','Gloria',4.30,'Desayuno','leche.svg'),('Avena Tradicional','Quaker',5.80,'Desayuno','avena.svg'),('Cafe Instantaneo','Altomayo',12.50,'Desayuno','cafe.svg'),('Pan Molde','Bimbo',8.90,'Desayuno','pan.svg'),('Mermelada Fresa','Fanny',7.20,'Desayuno','mermelada.svg'),('Cereal Chocolate','Angel',10.50,'Desayuno','cereal.svg'),('Mantequilla Barra','Laive',7.40,'Desayuno','mantequilla.svg'),
('Agua Sin Gas','San Luis',2.00,'Bebidas','agua.svg'),('Gaseosa Inca Kola','Inca Kola',3.80,'Bebidas','gaseosa.svg'),('Jugo Durazno','Frugos',4.50,'Bebidas','jugo.svg'),('Bebida Rehidratante','Sporade',3.20,'Bebidas','sporade.svg'),('Chicha Morada','Gloria',4.90,'Bebidas','chicha.svg'),('Energizante Lata','Volt',3.50,'Bebidas','volt.svg'),
('Papas Onduladas','Lays',3.50,'Snacks','papas.svg'),('Galleta Chocolate','Casino',2.20,'Snacks','galleta.svg'),('Chocolate Sublime','Nestle',2.50,'Snacks','chocolate.svg'),('Cereal Barrita','Angel',1.80,'Snacks','barrita.svg'),('Chifles Norteños','Tondero',4.90,'Snacks','chifles.svg'),('Maní Salado','Karinto',2.60,'Snacks','mani.svg'),('Cuates Picante','Karinto',1.40,'Snacks','cuates.svg'),
('Detergente Bolsa','Bolivar',8.50,'Limpieza','detergente.svg'),('Lavavajilla Limon','Sapolio',4.00,'Limpieza','lavavajilla.svg'),('Lejia Tradicional','Clorox',3.60,'Limpieza','lejia.svg'),('Papel Higienico','Elite',10.90,'Limpieza','papel.svg'),('Limpiatodo Floral','Poett',5.90,'Limpieza','limpiatodo.svg'),('Suavizante Azul','Bolivar',9.30,'Limpieza','suavizante.svg'),
('Yogurt Fresa','Gloria',5.60,'Lácteos','yogurt.svg'),('Queso Fresco','Laive',11.90,'Lácteos','queso.svg'),('Manjar Blanco','Nestle',8.20,'Lácteos','manjar.svg'),
('Jabon Tocador','Aval',2.80,'Cuidado Personal','jabon.svg'),('Shampoo Savila','Sedal',12.90,'Cuidado Personal','shampoo.svg'),('Pasta Dental','Dento',5.50,'Cuidado Personal','pasta_dental.svg'),('Cepillo Dental','Colgate',4.20,'Cuidado Personal','cepillo.svg'),('Pañitos Húmedos','Huggies',7.80,'Cuidado Personal','panitos.svg'),
('Filete De Atún','Florida',7.30,'Conservas','filete_atun.svg'),('Sardina En Salsa','A-1',5.40,'Conservas','sardina.svg'),('Durazno En Almibar','Aconcagua',9.70,'Conservas','durazno.svg'),('Frejol En Lata','Hoja Redonda',6.20,'Conservas','frejol_lata.svg'),
('Pollo Entero','San Fernando',18.90,'Carnes','pollo.svg'),('Hamburguesa Pack','Otto Kunz',14.50,'Carnes','hamburguesa.svg'),('Hot Dog Clásico','San Fernando',9.80,'Carnes','hotdog.svg'),('Chorizo Parrillero','Braedt',13.90,'Carnes','chorizo.svg'),
('Manzana Delicia','Perú',3.90,'Frutas Y Verduras','manzana.svg'),('Plátano Seda','Perú',2.80,'Frutas Y Verduras','platano.svg'),('Papa Blanca','Perú',2.40,'Frutas Y Verduras','papa_blanca.svg'),('Cebolla Roja','Perú',2.70,'Frutas Y Verduras','cebolla.svg')
]
...
def crear_imagenes_producto_demo():
    ...
    for nombre, marca, precio, pasillo, imagen in PRODUCTOS_DEMO:
        ...
        svg = f"<svg xmlns='http://www.w3.org/2000/svg' width='500' height='500' viewBox='0 0 500 500'><rect width='500' height='500' rx='48' fill='#f7fbef'/><circle cx='250' cy='205' r='120' fill='#a7d800' opacity='0.9'/><rect x='130' y='170' width='240' height='190' rx='28' fill='#ffffff' stroke='#334155' stroke-width='8'/><text x='250' y='242' font-family='Arial' font-size='44' font-weight='700' text-anchor='middle' fill='#334155'>{etiqueta}</text><text x='250' y='300' font-family='Arial' font-size='30' font-weight='700' text-anchor='middle' fill='#6b8e00'>{marca}</text><text x='250' y='395' font-family='Arial' font-size='28' font-weight='700' text-anchor='middle' fill='#334155'>S/ {precio:.2f}</text></svg>"
...
def sembrar_datos_demo():
    ...
    if total_clientes < 50:
        for i in range(50 - total_clientes):
            ...
            if not cursor.fetchone():
                cursor.execute('INSERT INTO Clientes (Nombre, Apellido, Celular, Correo, Direccion, Contraseña) VALUES (?, ?, ?, ?, ?, ?)', titulo(nombre), titulo(apellido), celular_demo, correo_demo, titulo(direccion), clave_hash)
    ...
    if total_productos < 50:
        for i in range(50 - total_productos):
            ...
            cursor.execute('INSERT INTO Productos (Nombre, Marca, Precio, Pasillo, Imagen) VALUES (?, ?, ?, ?, ?)', nombre_demo, titulo(marca), precio_demo, pasillo, f'img/productos/{imagen}')
    conexion.commit()
    conexion.close()
...
def index():
    ...
    try:
        ...
        pasillos = ['Abarrotes', 'Bebidas', 'Desayuno', 'Snacks', 'Limpieza']
...
def pasillo_dinamico(nombre_pasillo):
    mapa_pasillos = {
        'abarrotes': 'Abarrotes', 'bebidas': 'Bebidas', 'desayuno': 'Desayuno',
        'snacks': 'Snacks', 'limpieza': 'Limpieza', 'lacteos': 'Lácteos',
        'cuidado-personal': 'Cuidado Personal', 'conservas': 'Conservas',
        'carnes': 'Carnes', 'frutas-y-verduras': 'Frutas Y Verduras'
    }
...
def admin_sembrar_datos():
    if not session.get('admin'):
        return redirect(url_for('admin_login'))
    sembrar_datos_demo()
    flash('Se crearon datos ficticios de clientes y productos para probar el dashboard.')
...
def admin_clientes():
    ...
    try:
        ...
        if request.method == 'POST':
            flash('Render está trabajando en modo demostración sin SQL Server local. El cliente no se guardó en SQL, pero la página funciona para presentación.')
            return redirect(url_for('admin_clientes'))
        ...
        clientes_por_inicial = [fila_demo(Letra=k, Total=v) for k, v in sorted(conteo.items())[:6]]

    clientes_sin_celular = total_clientes - clientes_con_celular
    clientes_sin_direccion = total_clientes - clientes_con_direccion

    return render_template(
        'admin_clientes.html', clientes=clientes, total_clientes=total_clientes,
        clientes_con_celular=clientes_con_celular, clientes_con_direccion=clientes_con_direccion,
        clientes_sin_celular=clientes_sin_celular, clientes_sin_direccion=clientes_sin_direccion,
        clientes_por_inicial=clientes_por_inicial, ultimos_clientes=ultimos_clientes)
    ...
    try:
        ...
        if request.method == 'POST':
            ...
            if not nombre or not marca or not precio or not pasillo or not imagen:
                flash('Completa todos los datos del producto. Puedes escribir una ruta de imagen o subir un archivo.')
                conexion.close()
            ...
            crear_bloc_notas('producto', {'ID': id_producto_nuevo, 'Nombre': nombre, 'Marca': marca,
                'Precio': precio, 'Pasillo': pasillo, 'Imagen': imagen})
        ...
        if request.method == 'POST':
            flash('Render está trabajando en modo demostración sin SQL Server local. El producto no se guardó en SQL, pero la página funciona para presentación.')
            return redirect(url_for('admin_productos'))
        ...
        productos_por_pasillo = [fila_demo(Pasillo=k, Total=v) for k, v in sorted(conteo.items(), key=lambda x: x[1], reverse=True)]
        ultimos_productos = productos[:5]
        productos_economicos = len([p for p in productos if p.Precio <= 5])

    return render_template('admin_productos.html', productos=productos, total_productos=total_productos,
        precio_promedio=precio_promedio, total_pasillos=total_pasillos,
        producto_mayor_precio=producto_mayor_precio, productos_por_pasillo=productos_por_pasillo,
        ultimos_productos=ultimos_productos, productos_economicos=productos_economicos)
